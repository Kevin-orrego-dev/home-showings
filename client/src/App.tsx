...
import { BuyerSearchPage } from './features/buyer/BuyerSearchPage';
import { BuyerShowingsPage } from './features/buyer/BuyerShowingsPage';
    ...
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path="buyer" element={<RequireAuth role="buyer" />}>
          ...
          <Route path="showings" element={<BuyerShowingsPage />} />
        </Route>
